...
var Graticule = (function() {
  ...
  _.prototype.decToSex = function(d) {
    ...
    _.prototype.show = function() {
        this.get('container').style.display = 'block';
        google.maps.event.trigger(this.getMap(), 'idle');
    };
    _.prototype.hide = function() {
        this.get('container').style.display = 'none';
    };
    _.prototype.isVisible = function() {
        return this.get('container').style.display !== 'none';
    };
    ...
    _.prototype.draw = function() {
        ...
        if (this.get('container').style.display === 'none') {
            return;
        }
        ...
        var dLat = 1;//gridInterval(t - b, mins);
        var dLng = 1;//gridInterval(r > l ? r - l : ((180 - l) + (r + 180)), mins);
